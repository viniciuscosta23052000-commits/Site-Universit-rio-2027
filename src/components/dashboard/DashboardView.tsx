...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  const handleDrop = (targetId: string) => {
    ...
    StorageService.update((draft) => {
      ...
      const list = draft.profile.widgetsConfig;
      const dragWidget = list.find((w) => w.id === draggedId);
      const targetWidget = list.find((w) => w.id === targetId);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-start">
        {widgetsList
          ...
          .map((widget) => {
            ...
            const colSpan = getWidgetColSpan(widget.size || 'md');
              ...
              case 'profile_banner':
                return (
                  <div
                    ...
                    className={`relative rounded-3xl overflow-hidden shadow-xs border border-[#242427]/10 dark:border-[#242427] bg-[#121214] text-white group cursor-grab active:cursor-grabbing ${colSpan} transition duration-200`}
                  >
                    {widgetControls}
                    <div className="min-h-[26rem] w-full relative overflow-hidden bg-[#2d3a22] flex flex-col justify-between p-6 sm:p-8">
                      <img
                      ...
                      <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-3 w-full">
                        <div className="flex items-center gap-2 text-white/95 text-[10px] font-bold tracking-wider uppercase">
              ...
              case 'schedule':
                return (
                  <div
                    ...
                    onDragOver={handleDragOver}
                    onDrop={() => handleDrop(widget.id)}
                    className={`relative p-5 shadow-xs flex flex-col justify-between gap-4 group cursor-grab active:cursor-grabbing hover:scale-[1.005] duration-200 ${colSpan} ${bgClass} ${borderClass} ${roundedClass} ${textClass}`}
                  >
                    {widgetControls}
              ...
              case 'priority_tasks':
                return (
                  <div
                    ...
                    onDragOver={handleDragOver}
                    onDrop={() => handleDrop(widget.id)}
                    className={`relative p-5 shadow-xs flex flex-col gap-4 group cursor-grab active:cursor-grabbing hover:scale-[1.005] duration-200 ${colSpan} ${bgClass} ${borderClass} ${roundedClass} ${textClass}`}
                  >
                    {widgetControls}
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
              ...
              case 'today_tasks_widget':
                return (
                  <div
                    ...
                    onDragOver={handleDragOver}
                    onDrop={() => handleDrop(widget.id)}
                    className={`relative p-5 shadow-xs flex flex-col gap-3.5 group cursor-grab active:cursor-grabbing hover:scale-[1.005] duration-200 ${colSpan} ${bgClass} ${borderClass} ${roundedClass} ${textClass}`}
                  >
                    {widgetControls}
              ...
              case 'clock_widget':
                ...
                return (
                  <div
                    ...
                    onDragOver={handleDragOver}
                    onDrop={() => handleDrop(widget.id)}
                    className={`relative p-5 shadow-xs flex flex-col justify-center items-center group cursor-grab active:cursor-grabbing hover:scale-[1.005] duration-200 ${colSpan} ${bgClass} ${borderClass} ${roundedClass} ${textClass}`}
                  >
                    {widgetControls}
                    {clockStyle === 'big' && (
              ...
              case 'weather_widget':
                return (
                  <div
                    ...
                    onDragOver={handleDragOver}
                    onDrop={() => handleDrop(widget.id)}
                    className={`relative p-5 shadow-xs flex flex-col gap-3 group cursor-grab active:cursor-grabbing hover:scale-[1.005] duration-200 ${colSpan} ${bgClass} ${borderClass} ${roundedClass} ${textClass}`}
                  >
                    {widgetControls}
                    <div className="flex items-center justify-between border-b border-[#EAE3D5]/40 dark:border-zinc-800/40 pb-2">
                      <div className="flex items-center gap-1.5">
                    ...
                    <div className="text-center space-y-2">
                      {isEditingWeather ? (
                        ...
                        <button
                          ...
                          className="text-[10px] text-zinc-400 font-bold hover:underline flex items-center gap-1 mx-auto"
                        >
                      ...
                      <div className="flex items-center justify-center gap-3">
                        ...
                        <div>
                          ...
                          <span className="text-[10px] text-[#919196] uppercase tracking-wider font-bold block">{weatherDetails.condition}</span>
                        </div>
                      </div>
                ...
                return (
                  ...
                  >
                    ...
                    <textarea
                      ...
                      className="w-full h-[120px] bg-zinc-50/50 dark:bg-zinc-900/40 border border-[#EAE3D5]/40 dark:border-zinc-800 text-xs p-3 rounded-2xl focus:outline-none focus:border-zinc-400 text-zinc-700 dark:text-zinc-200 placeholder-zinc-400 resize-none"
                    />
                  </div>
                );
              ...
              case 'disciplines':
                return (
                  <div
                    ...
                    onDragOver={handleDragOver}
                    onDrop={() => handleDrop(widget.id)}
                    className={`relative p-1 gap-4 group cursor-grab active:cursor-grabbing hover:scale-[1.005] duration-200 ${colSpan}`}
                  >
                    {widgetControls}
